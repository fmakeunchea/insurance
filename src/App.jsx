    ...
    <>
      ...
      <section className="bg-white py-6">
        <div className="max-w-5xl mx-auto px-4">
          <a href="https://calendly.com/fifi-cornerstonelifeinsure" target="_blank" rel="noopener noreferrer" className="block rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow">
